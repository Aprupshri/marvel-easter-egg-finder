...
export default function QuizPlayer({ quiz, initialScore = null, isShared = false, onComplete }) {
  const [current, setCurrent] = useState(0);
  const [answers, setAnswers] = useState(new Array(quiz.length).fill(undefined));
