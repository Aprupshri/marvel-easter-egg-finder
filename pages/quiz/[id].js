...
export default function SharedQuiz() {
  ...
  const shareUrl = typeof window !== "undefined" ? `${window.location.origin}/quiz/${id}` : "";

  const shareOnTwitter = () => {
    const text = `I just took a Marvel Quiz and scored ${score}/${quizData.quiz.length}! Can you beat me?`;
